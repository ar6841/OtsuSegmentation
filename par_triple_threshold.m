function [S,t1_min,t2_min,t3_min]=par_triple_threshold(H,N)
...
%% Initialize variables
        ...
        for t2=2:254
            ...
            for t3=3:255
                ...
                if(sum(H(1:t1+1))>0 && sum(H(t1+2:t2+1))>0 && sum(H(t2+2:t3+1))>0 && sum(H(t3+2:256))>0)
                    ...
                    S_vec(t1,t2,t3) = Wa*Sa+Wb*Sb+Wc*Sc+Wd*Sd;
    ...
    [S,pos] = min(S_vec(:));
    [t1_min,t2_min,t3_min] = ind2sub(size(S_vec), pos);
end